...
const { novaPTView, registrarNovaPT, listarPT, exibirPT, listarPTFiltradas, listarPTPorProfissional, listarPTFiltradaPorProfissionalDeManutencao, assinarPT, concluirPT, cancelarPT } = require('./controllers/PTController');
...
app.get("/lista-pt/manutencao", listarPTPorProfissional);
app.post('/lista-pt/manutencao', listarPTFiltradaPorProfissionalDeManutencao);

//Definição da rota da tela que exibe uma PT registrada no banco de dados
app.get("/exibir-pt/:codigo_pt", exibirPT)
app.post("/exibir-pt/de-acordo", assinarPT)
app.post("/exibir-pt/concluir", concluirPT)
app.post("/exibir-pt/cancelar", cancelarPT)
