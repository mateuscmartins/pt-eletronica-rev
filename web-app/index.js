...
const { novaPTView, registrarNovaPT, listarPT, exibirPT, listarPTFiltradas, listarPTPorProfissional, listarPTFiltradaPorProfissionalDeManutencao, assinarPT, concluirPT } = require('./controllers/PTController');
